...
>
> **경로 규약**: 이 문서는 글로벌 정의 파일(`~/.claude/_harness/permissions.md`)이다. 표 안의 산출물 경로는 모두 **CWD 기준 `./_harness/...`** (프로젝트 로컬) 이다.
...
| Skills | 없음 |
| 금지 | 코드 수정, Bash 실행 |
| 산출물 | 정형화된 문서 파일 → 기본 `./_harness/security_engineer/docs/` (프로젝트 로컬), 중앙화 시 `~/.claude/_harness/security_engineer/docs/central/` |
...
| Skills | 없음 |
| 금지 | 코드 실행(Bash) |
| 산출물 | `./_harness/student/docs/` (프로젝트 로컬). 중앙화 시 `~/.claude/_harness/student/docs/central/` |

...
ln -s ~/.claude/hooks/model_switch.py ~/.claude/hooks/model_switch.py
ln -s ~/.claude/commands/se ~/.claude/commands/se
ln -s ~/.claude/commands/teacher ~/.claude/commands/teacher

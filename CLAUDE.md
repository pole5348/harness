...
4. **파일 위치 — 정의 vs 산출물 분리 (중요)**:
   - **정의 파일**(에이전트 시스템 프롬프트, `permissions.md`, `execute_library.md`)은 글로벌 위치 `/Users/pole/scripts/harness/harness/_harness/` 에 보관하며 절대 경로로 참조한다.
...
에이전트 정의 파일 위치(글로벌): `/Users/pole/scripts/harness/harness/_harness/security_engineer/`
...
| 단계 | 정의 파일 (글로벌) | 모델 | 역할 |
|---|---|---|---|
| 1. 계획 (plan) | `/Users/pole/scripts/harness/harness/_harness/security_engineer/01_plan.md` | claude-opus-4-6 이상 | PM/PO — 구체적 계획 수립 |
| 2. 비판 (critique) | `/Users/pole/scripts/harness/harness/_harness/security_engineer/02_critique.md` | claude-opus-4-6 이상 | PM/PO/보안팀/재무팀 — 계획 비판 |
| 3. 실행 (execute) | `/Users/pole/scripts/harness/harness/_harness/security_engineer/03_execute.md` | claude-sonnet-4-6 | 최종 plan.md 기반 실행, SBOM 생성 |
| 4. 검토 (review) | `/Users/pole/scripts/harness/harness/_harness/security_engineer/04_review.md` | claude-sonnet-4-6 또는 claude-haiku-4-5 | 종합 검토 및 리포트 |
| 5. 문서화 (document) | `/Users/pole/scripts/harness/harness/_harness/security_engineer/05_document.md` | claude-haiku-4-5 또는 claude-sonnet-4-6 | 정형화된 문서 생성 |
...
에이전트 정의 파일 위치(글로벌): `/Users/pole/scripts/harness/harness/_harness/student/`
...
| 단계 | 정의 파일 (글로벌) | 모델 | 역할 |
|---|---|---|---|
| 1. 질문 (ask) | `/Users/pole/scripts/harness/harness/_harness/student/01_ask.md` | claude-sonnet-4-6 또는 claude-haiku-4-5 | 개념 설명, 도표 활용 |
| 2. 문서화 (document) | `/Users/pole/scripts/harness/harness/_harness/student/02_document.md` | claude-sonnet-4-6 또는 claude-haiku-4-5 | 학습 내용 정리 문서 |
...
단계별 MCP, Skills, 권한 목록(정의): `/Users/pole/scripts/harness/harness/_harness/permissions.md`
실행 단계 라이브러리 상세(정의): `/Users/pole/scripts/harness/harness/_harness/security_engineer/execute_library.md`
